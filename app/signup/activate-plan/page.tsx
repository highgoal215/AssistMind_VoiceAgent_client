        ...
        <GradientBackground>
          <div className="px-6 lg:px-0  lg:pt-[70px] pt-[50px] pb-6 lg:pb-0 h-full overflow-y-auto lg:flex-1 lg:flex lg:flex-col lg:pl-[52px]">
            ...
            <div className="space-y-6 lg:space-y-0 lg:flex lg:flex-col lg:pt-10 lg:h-full">
              {/* Header Section */}
              <div className="flex flex-col justify-center items-center pt-10 lg:pt-0 lg:items-start">
                ...
                <p className="text-gray-600 mb-8 lg:mb-8 font-manrope lg:text-[18px] text-center lg:text-left">Start enjoying premium features — activate your plan now.</p>
              </div>
              ...
              <div className="space-y-6 lg:space-y-0 lg:grid lg:grid-cols-1 lg:gap-6 lg:max-w-4xl lg:h-full">
                ...
                <div className="relative bg-white rounded-2xl border border-gray-200 p-6 lg:px-6 lg:py-2">
                  ...
                  <div className="mb-6">
                    <h3 className="text-lg font-semibold text-gray-900 mb-4 font-manrope">Basic plan</h3>
                    ...
                    <Button
                      ...
                      className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 h-12 rounded-xl font-manrope"
                    >
                      Get started
                    </Button>
                  </div>
                ...
                <div className="relative bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-6 lg:px-6 lg:py-2 text-white">
                  ...
                  <div className="mb-6">
                    <h3 className="text-lg font-semibold mb-4 font-manrope">Business plan</h3>
                    <div className="flex items-baseline mb-6">
                ...
                <div className="relative bg-white rounded-2xl border border-gray-200 p-6 lg:px-6 lg:py-2">
                  <div className="mb-6">
                    <h3 className="text-lg font-semibold text-gray-900 mb-4 font-manrope">Enterprise plan</h3>
                    <div className="flex items-baseline mb-6">
