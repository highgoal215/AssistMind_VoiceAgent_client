        ...
        <GradientBackground>
          <div className="px-6 lg:px-0  lg:pt-[70px] pt-[50px] pb-6 lg:pb-0 h-full overflow-y-auto lg:flex-1 lg:flex lg:flex-col lg:pl-[52px] overflow-auto">
            ...
            <div className="space-y-6 lg:space-y-0 lg:flex lg:flex-col lg:pt-14">
              {/* Header Section */}
              <div className="flex flex-col justify-center items-center pt-6 lg:pt-0 lg:items-start">
                <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-2 font-manrope text-center lg:text-left">Stripe checkout</h2>
                <p className="text-gray-600 mb-8 lg:mb-8 font-manrope lg:text-lg text-center lg:text-left">Securely complete your payment via Stripe. All major cards accepted.</p>
              </div>
              ...
              <div className="space-y-6 lg:space-y-2 lg:flex lg:flex-col">
                ...
                <button
                  ...
                  className="w-full bg-black text-white rounded-lg py-4 h-12 flex items-center justify-center space-x-2 hover:bg-gray-800 transition-colors font-manrope"
                >
                  <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z" />
                  </svg>
                  <span className="font-manrope">Pay</span>
                </button>
                ...
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-2 bg-white text-gray-500 font-manrope">Or pay with a card</span>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-[14px] lg:gap-[14px]">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className="w-full h-12 lg:h-[56px] border-2 border-blue-600 lg:border-gray-300 rounded-lg pl-12 lg:pl-16 font-manrope"
                    />
              ...
              <div className="space-y-4 lg:space-y-0 lg:pt-[40px]">
                ...
                <div className="lg:hidden flex space-x-4 pt-4">
                  <Button onClick={handleBack} variant="outline" className="flex-1 py-3 h-12 bg-transparent font-manrope rounded-lg">
                    Back
                  </Button>
                  <Button
                    onClick={handlePayment}
                    className="flex-1 bg-blue-600 hover:bg-blue-700 text-white py-3 h-12 font-manrope rounded-lg"
