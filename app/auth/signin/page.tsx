            ...
            <div className="flex flex-col w-full gap-[40px]">
              ...
              <div className="space-y-6">
                <div className="flex flex-col gap-4">
                  <Label htmlFor="email" className="text-md font-bold font-manrope text-gray-700 mb-2 block">
                    Email Address
                  </Label>
                  <Input
                    id="email"
                    ...
                    className="w-full h-12 lg:h-auto border border-gray-300 rounded-lg font-manrope"
                  />
                </div>
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className="w-full h-12 lg:h-auto border border-gray-300 rounded-lg pr-12 font-manrope"
                    />
                    <button
                      type="button"
                ...
                <Button
                  ...
                  className="w-full font-semibold bg-[#4A48FF] hover:bg-blue-700 text-white py-3 h-12 lg:h-auto rounded-lg text-base font-manrope"
                ...
                <Button
                  ...
                  variant="outline"
                  className="w-full text-md font-semibold py-3 h-12 lg:h-auto rounded-lg text-base font-manrope bg-white border border-gray-300 flex items-center justify-center space-x-2"
                >
                ...
                <div className="text-center font-medium font-manrope ">
                  <span className="text-gray-600 font-manrope">Don't have an Account? </span>
                  <button onClick={handleSignUp} className="text-red-600 hover:text-red-400 font-manrope">
                    Sign Up
                  </button>
                </div>
              </div>
